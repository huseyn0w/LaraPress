...
$icons = [
    ...
    'grip' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5" />',
];
$path = $icons[$name] ?? '';
@endphp
...
<svg
    ...
    aria-hidden="true"
    @endif
    {{ $attributes->merge(['width' => '20', 'height' => '20']) }}
>{!! $path !!}</svg>
